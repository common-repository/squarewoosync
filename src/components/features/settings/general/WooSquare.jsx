...
const WooSquare = ({ settings, settingsLoading }) => {
				...
				{wooSquare.isActive && !settingsLoading && (
					<>
						<p className="mt-4">
							...
							from Woo to Square (other wise an infinite update loop is created, we don't want that). You can also manually sync from the product actions.
						</p>
