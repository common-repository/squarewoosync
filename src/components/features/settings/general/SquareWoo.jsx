...
const SquareWoo = ({ settings, settingsLoading }) => {
  ...
  return (
    <div className="px-4 pb-5 sm:px-6">
      <h3 className="text-base font-semibold leading-6 text-gray-900">
        Automatic syncing on product update <a className="pro-badge !relative" href="https://squaresyncforwoo.com" target="_blank">PRO ONLY</a>
      </h3>
      <div className="mt-2 max-w-xl text-sm text-gray-500 mb-4">
        <p>
          Enable or disable automatic inventory syncing between Woo and Square
          effortlessly with our Inventory Sync Toggle. This automatic update is
          triggered when your Square or Woocommerce data is updated.
          <br></br>
          <a
            ...
            target="_blank"
          >
            How to setup and control automatic syncing between Square and Woo
          </a>
        </p>
      </div>
      <div className="">
